 ...
 */
@Information(name = "REST Service Status Plugin", author = "Christoph Schaebel", version = "1.0.0-SNAPSHOT")
public class RestStatusPlugin extends HiveMQPluginModule {
    ...
    protected Class<? extends PluginEntryPoint> entryPointClass() {
        return RestStatusEntryPoint.class;
    }
}
