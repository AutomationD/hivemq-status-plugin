 ...
 */
public class RestStatusEntryPoint extends PluginEntryPoint {

    Logger log = LoggerFactory.getLogger(RestStatusEntryPoint.class);

    private final RESTService restService;

    @Inject
    public RestStatusEntryPoint(final RESTService restService) {
...
//        restService.addListener(new HttpListener("other", "0.0.0.0", 8888));
        ...
        restService.addJaxRsResources(StatusResource.class);

        //add the Servlet to the RESTService
        restService.addServlet(StatusServlet.class, "/status");
    }
